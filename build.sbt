...
libraryDependencies ++= Seq(
	...
	"com.typesafe.akka" % "akka-slf4j" % "2.0.4" withSources(),
	"com.typesafe.akka" % "akka-kernel" % "2.0.4" withSources(),
	"com.typesafe.akka" % "akka-actor" % "2.0.4" withSources(),
	"com.typesafe.akka" % "akka-zeromq" % "2.0.4" withSources(),
	"com.typesafe.akka" % "akka-remote" % "2.0.4" withSources(),
